...
def deduplicate_summary(spreadsheet_id: str):
    ...
    for sheet in sheets:
        ...
        data = google_sheets.get_sheet_values(sheets_service, spreadsheet_id, sheet_name)
        ...
        format.update_sheet_values(sheets_service, spreadsheet_id, sheet_name, final_data)
